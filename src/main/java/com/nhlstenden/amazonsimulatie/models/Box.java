...
class Box implements Object3D, Updatable {
    ...
    // Stuurt de doos in de lucht, dit zodat het lijkt dat de doos niet meer
    // bestaat. Dit wordt gebruikt om de doos te verwijderen
    public void launch() {
        this.y = 1000;
    }
    ...
    // Zorgt ervoor zodat een animatie kan worden verstuurd naar de actielijst van
    // de doos, zodat de doos een animatie kan uitvoeren.
    ...
    public boolean update() {
        // Loopt de actielijst af zodat een voor een de posities worden aangenomen zodat
        // het lijkt alsof de doos beweegt.
